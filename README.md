...
![categoria-inicio](./imagem/categoria-inicio.png "Categoria antes")
![categoria-final](./imagem/categoria-final.png "Categoria depois")
...
![data-original](./imagem/data_original.png "data orignal")

2. Visto que é a formatação é americana então foi necessario alterar apenas a localidade dos dados:

![alteracao-data](./imagem/alteracao-data.png "alteracao dos dados")

3. E como resultado:

![data-final](./imagem/data_final.png "data final")
...
![relacionamento1](./imagem/relacionamento1.png "Relacionamento")
